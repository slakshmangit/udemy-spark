...
val lotsOfNumbers = numberList ++ moreNumbers;System.out.println("""lotsOfNumbers  : List[Int] = """ + $show(lotsOfNumbers ));$skip(51); 
// More list fun
...
var n = List[Int]();System.out.println("""n  : List[Int] = """ + $show(n ));$skip(37); 
for(i <- 1 to 10)
{
n = n ++ List(i)
};$skip(13); 
