object LearningScala1 {
  ...
  val hello: String = "hello world!!!"              //> hello  : String = hello world!
  println(hello)                                  //> hello world!

  val constantValue: Int = 100                    //> constantValue  : Int = 100
  println(constantValue)                          //> 100

  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.

  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = hello world!
  helloThere = hello + " There!"
  println(helloThere)                             //> hello world! There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = hello world!There!
  println(immutableHelloThere)                    //> hello world!There!
  ...
  println(f"Zero padding on the left: $numberOne%.2f")
  //> Zero padding on the left: 1.00
  ...
  val isBest1: Boolean = 1 == 2                 //> isBest1  : Boolean = false
  ...
  val piSquare = pi*2                             //> piSquare  : Double = 6.2831853
  println(f"$piSquare%.3f")                       //> 6.283

  var y = 5                                       //> y  : Int = 5
  def apply (x:Int) = x +y                        //> apply: (x: Int)Int
